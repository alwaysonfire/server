...
const thisWeekFilePath = path.join(__dirname, "data", attendanceFileName);
...
app.post("/addMember/:memberName", (req, res) => {
  try {
    ...
    jsonData.push(newMemberObj);

    fs.writeFileSync(attendanceFilePath, JSON.stringify(jsonData, null, 2));
